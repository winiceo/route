...
module.exports = function (app) {
    ...
    var userRequired = middleware.userRequired();
    var adminRequired = middleware.adminRequired();
    var createTopicLimit = middleware.createTopicLimit(config.topic);
    var createUserLimit = middleware.createUserLimit(config.create_user_per_ip);
    ...
    var localStrategy = app.passport.authenticate('local', {
        'successRedirect': '/',
